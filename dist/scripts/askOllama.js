...
async function getAppSummary() {
    try {
        const res = await (0, node_fetch_1.default)("http://localhost:3333/mcp", {
            method: "POST",
            headers: {
...
async function askOllama(prompt) {
    try {
        const res = await (0, node_fetch_1.default)("http://127.0.0.1:11434/api/completions", {
            method: "POST",
...
async function askOllamaWithAppSummary(userPrompt) {
...
// Example usage
(async () => {
    await askOllamaWithAppSummary("Explain the current high-priority tickets and their owners.");
})();
